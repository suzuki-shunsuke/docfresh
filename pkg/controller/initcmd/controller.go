// Package initcmd implements the business logic for the 'docfresh init' command.
// It handles the creation of docfresh configuration files with default templates.
package initcmd
